 ...
 */
final class Version20230409233749 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, place_id INT NOT NULL, paiement_id INT NOT NULL, client_id INT NOT NULL, date_reservation DATE NOT NULL, type_vehicule VARCHAR(100) NOT NULL, INDEX IDX_42C84955DA6A219 (place_id), UNIQUE INDEX UNIQ_42C849552A4C4478 (paiement_id), INDEX IDX_42C8495519EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
