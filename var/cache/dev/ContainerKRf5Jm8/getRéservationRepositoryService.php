 ...
 */
class getRéservationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RéservationRepository' shared autowired service.
     *
     * @return \App\Repository\RéservationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RéservationRepository.php';

        return $container->privates['App\\Repository\\RéservationRepository'] = new \App\Repository\RéservationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
