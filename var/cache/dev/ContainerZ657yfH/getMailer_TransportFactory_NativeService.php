...
<<<<<<< HEAD:var/cache/dev/ContainerFF9ljFM/getMailer_TransportFactory_NativeService.php
<<<<<<<< HEAD:var/cache/dev/ContainerOhpH17T/getMailer_TransportFactory_NativeService.php
namespace ContainerOhpH17T;

========
namespace ContainerFF9ljFM;
>>>>>>>> 4e6b7b2fd64ebad93ea245379d93b8ad6abb4679:var/cache/dev/ContainerFF9ljFM/getMailer_TransportFactory_NativeService.php
=======
namespace ContainerZ657yfH;
>>>>>>> 22706224e6831c1c2fb6365639649c394e2f61b7:var/cache/dev/ContainerZ657yfH/getMailer_TransportFactory_NativeService.php
...
class getMailer_TransportFactory_NativeService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return new \Symfony\Component\Mailer\Transport\NativeTransportFactory(($container->services['event_dispatcher'] ?? $container->getEventDispatcherService()), ($container->privates['.debug.http_client'] ?? $container->get_Debug_HttpClientService()), ($container->privates['logger'] ?? $container->getLoggerService()));
    }
}
